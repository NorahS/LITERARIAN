...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
	...
	<title>Lirerarian | Browse Courses</title>
...
<div class="loading"> 
	...
	<div class="container-fluid">
		...
		<nav class="navbar navbar-default">
			...
			<div class="container-fluid menu">
				...
				<div class="collapse navbar-collapse" id="mainmenu">
					...
					<li class="current"><a href="Literarian_courses.php">Browse Courses</a></li>
		...
		<div class="container">
		  <div class="col-xm-12 col-lg-6 col-md-6"><h2 class="title" style="border:0;">Courses</h2></div> 
				...
				if(!$connection) die ("Unable to connect to database.");
				 $numOfResults=0;
					if(isset($_GET['search'])){
						 $search= $_GET["search"];
						 $query = "SELECT * FROM courses WHERE course= '$search'";
						...
						echo "<div class='listcontent secondtitle'>
								   ...
								   <a href='Literarian_books.php?course=$cid'>$row[1]</a>
				...
				$courses = mysqli_query($connection,$query);
					...
					$cid = $row['course'];		
						echo "<div class='listcontent secondtitle'>
									...
									<a href='Literarian_books.php?course=$cid'>".$row['course']."</a>
